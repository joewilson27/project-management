...
//			// add employee to project (to mapping table)
//			pro1.addEmployee(emp1); // pro1.setEmployees(Arrays.asList(emp1));
...
//			
//			// need to set both sides of the relationship manually
//			// add project to an employee (to mapping table)
